...
public:
	...
	static BlockGraphicsPipeline* GetInstance();
...
private:
	BlockGraphicsPipeline() = default;
	~BlockGraphicsPipeline() = default;
	BlockGraphicsPipeline(const BlockGraphicsPipeline&) = delete;
	BlockGraphicsPipeline& operator=(const BlockGraphicsPipeline&) = delete;
