...
void to_json(nlohmann::json &json, const Vector2 &data) {
	json = *reinterpret_cast<const std::array<float, 2u>*>(&data);
}
void to_json(nlohmann::json &json, const Vector3 &data) {
	json = *reinterpret_cast<const std::array<float, 3u>*>(&data);
}
void to_json(nlohmann::json &json, const Vector4 &data) {
	json = *reinterpret_cast<const std::array<float, 4u>*>(&data);
}
